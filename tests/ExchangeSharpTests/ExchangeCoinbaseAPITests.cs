...
namespace ExchangeSharpTests
{
	...
	{
		private async Task<ExchangeCoinbaseProAPI> MakeMockRequestMaker(string response = null)
		{
			...
			var api = (
					await ExchangeAPI.GetExchangeAPIAsync(ExchangeName.CoinbasePro) as ExchangeCoinbaseProAPI
			)!;
